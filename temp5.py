import subprocess
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QLabel, QProgressBar, QTextEdit, QPushButton, QMessageBox
...
class MainWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Shell Script 실행")
    ...
    def start_script(self):
        self.thread = ShellScriptThread(". shell/infer_whole.sh")  # 실행할 셸 스크립트 파일 이름으로 변경해야 함
