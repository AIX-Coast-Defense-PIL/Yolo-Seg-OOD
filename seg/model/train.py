...
class LitModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.separation_loss == 'wsl':
            ...
            separation_loss = contr_water_sky_obstacle_combined_separation_loss(out['aux'], batch['segmentation'])
        elif self.separation_loss == 'cwosl':
            separation_loss = contr_water_obstacle_combined_separation_loss(out['aux'], batch['segmentation'])
        elif self.separation_loss == 'hwssl':
            separation_loss = half_contr_water_sky_obstacle_combined_separation_loss(out['aux'], batch['segmentation'])
        elif self.separation_loss == 'hwosl':
            separation_loss = half_contr_water_obstacle_combined_separation_loss(out['aux'], batch['segmentation'])
