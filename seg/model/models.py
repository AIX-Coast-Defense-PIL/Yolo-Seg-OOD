...
model_list = ['wasr_resnet101', 'wasr_resnet101_imu', 'wasr_resnet50', 'wasr_resnet50_imu',
              'deeplab', 'wodis']
model_urls = {
...
def get_model(model_name, num_classes=3, pretrained=True):
    ...
    elif model_name == 'wodis':
        model = WODIS_model(is_training=True, num_classes=num_classes)
    else:
